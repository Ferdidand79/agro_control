<x-app-layout>
    ...
    <!--<section class="w-full flex bg-fixed" style="background-image: url({{ asset('img/home/portada01.png') }})">
        <div class="max-w-max mx-auto px-5 sm:px-6 lg:px-8 py-5">
             tailwind.config.js
        </div>
    </section>-->
    <!--<main>
    ...
    <main class="bg-gray-100 font-montserrat">
        <header class="h-24 sm:h-32 flex items-center">
            <div class="container mx-auto px-6 sm:px-12 flex items-center justify-between">
                <div class="font-black text-blue-900 text-2xl flex items-start">
                    Agrotecap<span class="w-3 h-3 rounded-full bg-purple-600 ml-2"></span>
                </div>
        ...
        <div class="container mx-auto px-6 sm:px-12 flex flex-col-reverse sm:flex-row relative">
                ...
                <svg class="w-full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    <g style="isolation:isolate">
                        <g id="Capa_1" data-name="Capa 1">
                            <polygon points="239.69 35.48 238.45 23.87 273.51 11.88 239.69 35.48"
                                style="fill:#9c96c3" />
                            <polygon points="273.51 11.88 248.59 36.8 240.91 27.2 273.51 11.88" style="fill:#dcdcee" />
                            <polygon points="273.51 11.88 238.45 23.87 231.12 14.74 273.51 11.88"
                                style="fill:#dcdcee" />
            ...
            <div
                class="sm:w-10/12 xl:w-8/12 flex flex-col items-start sm:items-end sm:text-right ml-auto mt-8 sm:mt-0 relative z-10 xl:pt-20 mb-16 sm:mb-0">
                <h1 class="text-4xl lg:text-5xl text-blue-900 leading-none mb-4 font-black">Bienvenido a AgroControl
                </h1>
                <p class="lg:text-lg mb-4 sm:mb-12 text-blue-900">Aqui podras llevar el control de las muestras de las zonas agrarias y anotar todas las observaciones necesarias, asi como gestionar las estadisticas del portal.</p>
                <a href="#"
                    class="font-semibold text-lg bg-purple-600 hover:bg-blue-400 text-white py-3 px-12 rounded-full">INICIAR</a>
            </div>
            <svg class="w-full absolute bottom-0 left-0" id="Capa_1" data-name="Capa 1"
                ...
                <rect x="107.48" y="72.92" width="18.2" height="1.6" transform="translate(233.16 147.45) rotate(180)"
                    style="fill:#d0d4ea" />
                <polygon points="91.33 148.86 123.9 148.86 124.21 47.59 91.33 44.19 91.33 148.86"
                    style="fill:#d0d4ea" />
        ...
        <div class="w-full min-h-screen flex items-center justify-center bg-black">
            <div class="md:w-2/3 w-full px-4 text-white flex flex-col">
                <div class="w-full text-7xl font-bold">
                    <h3 class="w-full md:w-2/3">Agro Control</h1>
                </div>
                <div class="flex mt-8 flex-col md:flex-row md:justify-between">
                    <p class="w-full md:w-2/3 text-gray-400">Para una mejor gestion de las muestras de analisis, en los
                        distintos viveros forestales de la region.</p>
                    <div class="w-44 pt-6 md:pt-0">
                        <a href="{{ route('muestras.index') }}"
                            class="bg-green-500 justify-center text-center rounded-lg shadow px-10 py-3 flex items-center">Contactar</a>
                    </div>
                </div>
                <div class="flex flex-col">
                    <div class="flex mt-24 mb-12 flex-row justify-between">
                        <div class="">
                            <svg width="84" height="25" viewBox="0 0 84 25" fill="none"
                    ...
                    <p class="w-full text-center my-12 text-gray-600">Copyright © 2021 Todos los derechos reservados</p>
                </div>
            </div>
        </div>
    </footer>
