                        ...
                        <table class="min-w-full max-w-max w-full table-auto">
                            ...
                            <thead>
                                <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                    ...
                                    <th class="py-3 px-6 text-center">LUGAR</th>
                                ...
                                <tr class="border-b border-gray-200 hover:bg-gray-100">
                                    ...
                                    <td class="py-3 px-6 text-left whitespace-nowrap">
                                        <div class="flex items-center">
                                            <span class="font-medium">{{ $elemento['id'] }}</span>
                                        </div>
                                    </td>
                                        ...
                                        <div class="flex items-center">
                                            <div class="mr-2">
                                                <img class="h-8 w-8 rounded-full object-cover"
                                                    src="{{ $elemento->user->profile_photo_url }}"
                                                    alt="{{ $elemento->user->name }}" />
                                            </div>
                                            <span>{{ Str::limit($elemento->user->name, 30) }}</span>
                                        </div>
                                    </td>
                                    ...
                                    <td class="py-3 px-6 text-left whitespace-nowrap">
                                        <div class="flex item-center justify-center">
                                            <button href="{{ route('elementos.index') }}"
                                                class="bg-green-500 hover:bg-green-700 text-md text-white font-bold py-1 px-3 rounded mx-1">
                                                Galeria
                                            </button>
                                            <button href="{{ route('elementos.index') }}"
                                                class="bg-green-500 hover:bg-green-700 text-md text-white font-bold py-1 px-3 rounded mx-1">
